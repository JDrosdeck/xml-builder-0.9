...
class _XMLNode(object):
    ...
    def __init__(self,parent,node_name,builder):
    ...
    def __enter__(self):
        self.parent += 1
        self.builder.start(self.node_name,self.attrs)
        self.builder.data("".join(self.text))
        self.entered = True
        return self
    def __exit__(self,x,y,z):
        self.parent -= 1
        self.builder.end(self.node_name)
        return False
#-------------------------------------------------------------------------------
class XMLBuilder(object):
    ...
    def __getattr__(self,node_name):
        return _XMLNode(self,node_name,self.__builder)
    def __call__(self,node_name,*dt,**mp):
        x = _XMLNode(self,node_name,self.__builder)
        x(*dt,**mp)
        return x
    #create new tag or add text
    #possible shift values
    #string - text
    #tuple(string1,string2,dict) - new tag with node_name string1,attrs = dict,and text string2
